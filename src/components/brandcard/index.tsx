...
//   },
//   { source: "http://www.slist.kr/news/photo/202011/198169_338203_5518.jpg" },
//   {
//     source:
//       "https://yt3.ggpht.com/Uqhf9MBF3oGaRUKoQS3V3aBXS-jRfWrpUBeE7gJZsUBQ7GtrF-iuS1jBQXVn061-CTuddvjiT7c=s900-c-k-c0x00ffffff-no-rj",
//   },
//   { source: "https://t1.daumcdn.net/cfile/tistory/9989D4425B1E3C9501" },
//   {
//     source:
...
//   {
//     source:
//       "https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=http%3A%2F%2Fcfile9.uf.tistory.com%2Fimage%2F9951424F5E738F43302C78",
//   },
// ];
    ...
    <BrandCardContainer>
      ...
      <BrandCardInner
        style={{
          ...
          backgroundPosition: "124px -100px"
        }}
      >
        <Title>폴바셋</Title>
        <Desc>
      ...
      >
        <Title></Title>
        <Desc>
          커피베이는 5가지 아라비카 원두를 최적의 배합 비율로 블랜딩하여 가장
          맛있는 커피 맛을 구현하였습니다. 또한 신선한 원두만을 사용하기 때문에
          그 향과 맛을 그대로 살릴 수 있는 태우지 않는 미디엄 로스팅 방식을
          고수합니다.
        </Desc>
      </BrandCardInner>
      <BrandCardInner
      ...
      >
        <Title></Title>
        <Desc>
          ‘Fresh roast daily’는 창립자 허버트 하이먼과 모나 하이먼이 처음으로
          개점했던 캘리포니아브렌트우드에서 커피를 가공한 이후로 면면히
          이어져오는 저희의 모토입니다. 최상의 신선도와탁월한 맛을 즐길 수
          있도록 최고의 포장 상태를 유지하여 갓 볶아낸 신선함 그대로 제공 드리고
          있습니다.
        </Desc>
      </BrandCardInner>
      <BrandCardInner
      ...
      >
        <Title></Title>
        <Desc>
          스타벅스 로스트 스팩트럼은 다년 간의 연구와 장인정신으로
          탄생했습니다.” 모든 원두는 온도와 시간이 균형을 이루어야 그 향과
          청량감, 바디와 풍미가 최고 수준에 이릅니다. 우리의 커피는 세 가지
          로스팅으로 분류됩니다. - 블론드 로스트, 미디엄 로스트, 다크
          로스트.그래서 당신에게 맞는 풍미와 강도를 쉽게 찾을 수 있습니다.
        </Desc>
      </BrandCardInner>
    </BrandCardContainer>
  );
