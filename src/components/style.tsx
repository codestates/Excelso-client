...
export const SignupInfoName = styled.div`
  margin-right: 24px;
  width: 25%;
`
...
export const MypageInfoName = styled.div`
  width: 25%;
  text-align: left;
  margin-left: 48px;
`

export const MypageInfoEmail = styled.div`

`

export const MypageInfoNick = styled.div`

`

export const ChangeNicknameBtn = styled.button`
  margin-left: 16px;
  outline: none;
  background-color: #fff;
  color: #262223;
